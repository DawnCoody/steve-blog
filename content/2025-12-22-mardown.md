...
articleId: db96f683-f6c9-43a6-8237-cee1bfac8d56
---

# Markdown基本语法
> By Steve, Written with Typora.
...
|:--------:| -------------:|:---------------------|
| centered 文本居中 | right-aligned 文本居右 | left-aligned|
# 注脚
一个具有注脚的文本。[^1]
[^1]: 注脚的解释
...
gantt
        ...
        section 现有任务
        已完成               :done,    des1, 2014-01-06, 1d
        进行中               :active,  des2, 2014-01-07, 4d
